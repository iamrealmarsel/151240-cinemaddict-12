...
const createFilmDetailsMarkup = (filmMocks) => {
  ...
  const {title, poster, description, comments, rate, duration, genres, releaseDate, director, writers, actors, country, age} = filmMocks;
  ...
  const commentsMarkup =
    `<ul class="film-details__comments-list">
      ${comments.map(({emoji, text, author, date}) =>
