...
const createStatisticMarkup = (period, watchedFilms, topGenre, profileRating) => {
  ...
  <section class="statistic">
    ...
    <form action="https://echo.htmlacademy.ru/" method="get" class="statistic__filters">
      ...
      <input type="radio" class="statistic__filters-input visually-hidden" name="statistic-filter" id="statistic-all-time" value="${StatisticPeriod.ALLTIME}" ${StatisticPeriod.ALLTIME === period ? `checked` : ``}>
      <label for="statistic-all-time" class="statistic__filters-label">All time</label>

      <input type="radio" class="statistic__filters-input visually-hidden" name="statistic-filter" id="statistic-today" value="${StatisticPeriod.TODAY}" ${StatisticPeriod.TODAY === period ? `checked` : ``}>
      <label for="statistic-today" class="statistic__filters-label">Today</label>

      <input type="radio" class="statistic__filters-input visually-hidden" name="statistic-filter" id="statistic-week" value="${StatisticPeriod.WEEK}" ${StatisticPeriod.WEEK === period ? `checked` : ``}>
      <label for="statistic-week" class="statistic__filters-label">Week</label>

      <input type="radio" class="statistic__filters-input visually-hidden" name="statistic-filter" id="statistic-month" value="${StatisticPeriod.MONTH}" ${StatisticPeriod.MONTH === period ? `checked` : ``}>
      <label for="statistic-month" class="statistic__filters-label">Month</label>

      <input type="radio" class="statistic__filters-input visually-hidden" name="statistic-filter" id="statistic-year" value="${StatisticPeriod.YEAR}" ${StatisticPeriod.YEAR === period ? `checked` : ``}>
